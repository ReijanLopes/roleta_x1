...
export default function TermsPage() {
  return (
    <main className="min-h-screen bg-gradient-to-b dark:text-white from-black via-zinc-900 to-purple-900">
          ...
          <div className="space-y-8 text-white/90">
            ...
            <section className="space-y-3">
              ...
              <p className="leading-relaxed">
                ...
                <strong className="font-semibold text-white">X1 Games Experience</strong>,
            ...
            <section className="space-y-3">
              ...
              <ul className="ml-6 list-disc space-y-2 leading-relaxed">
                <li>
                  Realizar a{' '}
                  <strong className="font-semibold text-white">compra de 1 hora</strong> em
                  qualquer equipamento no período entre{' '}
                  <strong className="font-semibold text-white">16h e 18h</strong>.
                </li>
              </ul>
              <p className="leading-relaxed">
            ...
            <section className="space-y-3">
              ...
              <p className="leading-relaxed">
                ...
                <strong className="font-semibold text-white">100% aleatória</strong>.
              </p>
            </section>
